...
# 攻撃の当たり判定の召喚 → スコア等の代入
 execute positioned ^ ^ ^1.75 run summon armor_stand ~ ~ ~ {Team:"Player",NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["Pjtl","Pjtl.Undefined"],Pose:{Head:[1f,1f,1f]},ArmorItems:[{},{},{},{id:"minecraft:diamond_sword",Count:1b,tag:{Unbreakable:1b,CustomModelData:1}}]}
